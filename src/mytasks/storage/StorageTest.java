...
public class StorageTest {
	...
	private void initArrays() {
		try {
			...
			Date d3 = MyTasksParser.dateFormats.get(0).parse("06.10.2014 15:00");
			Date d4 = MyTasksParser.dateFormats.get(0).parse("07.10.2014 15:00");
