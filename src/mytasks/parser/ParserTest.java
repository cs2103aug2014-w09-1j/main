...
public class ParserTest {
	...
	private void initAddObjects() {
		try {
			test1 = new AddCommand("add", "dinner", null, null, null, null);
			
			Date date2 = MyTasksParser.dateFormats.get(0).parse("18.09.2014");
			test2 = new AddCommand("add", "dinner", date2, null, null, null);
			
			Date date3 = MyTasksParser.dateFormats.get(1).parse("20.09.2014 12:00");
			test3 = new AddCommand("add", "submit assignment", date3, null, null, null);
			
			ArrayList<String> list4 = new ArrayList<String>();
			list4.add("cs2103");
			Date date4 = MyTasksParser.dateFormats.get(0).parse("19.09.2014");
			test4 = new AddCommand("add", "do homework", date4, null, list4, null);
			...
			test5 = new AddCommand("add", "do homework", date5, null ,list5, null);
			
			ArrayList<String> list6 = new ArrayList<String>();
			list6.add("notpossible");
			Date date6 = MyTasksParser.dateFormats.get(0).parse("18.09.2014");
			test6 = new AddCommand("add", "have fun!", date6, null, list6, null);
			...
			test12 = new AddCommand("add", "code for project", date121, date122, null, null);
	...
	private void initDeleteObjects() {
		test7 = new DeleteCommand("delete", "CS2103 meeting", null, null, null, null);
	}
	
	private void initUpdateObjects() {
		try {
			test8 = new UpdateCommand("update", "CS2103 meeting", null, null, null, "meeting");
			
			Date date9 = MyTasksParser.dateFormats.get(0).parse("20.09.2014");
			test9 = new UpdateCommand("update", null, date9, null, null, "meeting cs2103");
			
			ArrayList<String> list10 = new ArrayList<String>();
			list10.add("CS2103");
			test10 = new UpdateCommand("update", null, null, null, list10, "meeting");
			
			ArrayList<String> list11 = new ArrayList<String>();
			list11.add("yolo");
			Date date11 = MyTasksParser.dateFormats.get(0).parse("19.09.2014");
			test11 = new UpdateCommand("update", "play", date11, null, list11, "meeting");
			...
			test13 = new UpdateCommand("update", "write report", date131, date132, list13, "read book");
			...
			test14 = new UpdateCommand("update", "wake up", date141, date142, null, "sleep");
		} catch (ParseException e) {
			e.printStackTrace();
		}
	}
